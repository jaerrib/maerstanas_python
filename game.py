class Game:
    ...
    def check_player_hinges(self, row_number, col_number):
        """
        ...
        for position in range(0, len(adjacent_positions)):
            ...
            position_check = self.board.data[row_to_check][col_to_check]
            if position_check != 0:
                hinges += 1
        if hinges > 3:
            return True
    ...
    def hinge_check(self, row_number, col_number):
        """
    ...
    def check_adjacent_stones(self, row_number, col_number):
        """
        ...
        for i in range(0, len(adjacent_positions)):
            ...
            board_value = self.board.data[row_position][col_position]
            if board_value == 3 or board_value == 0:
                pass
            elif board_value == 1 or board_value == 2:
                if self.hinge_check(row_position, col_position) >= 3:
                    return True
        return False
    ...
    def valid_move(self, row_number, col_number):
        """
    ...
    def check_score(self, player):
        ...
        for row_index in range(1, 9):
            for col_index in range(0, 9):
                ...
                comparison_position = self.board.data[row_index - 1][col_index]
        ...
        for row_index in range(1, 9):
            for col_index in range(0, 9):
                board_position = self.board.data[row_index][col_index]
                comparison_position = self.board.data[row_index][col_index - 1]
                if comparison_position == player \
                        and board_position == player:
                    calculated_score += 1
                elif comparison_position == 3 and board_position == player:
    ...
    def viable_moves(self):
        ...
        for row_index in range(1, 9):
            for col_index in range(1, 9):
                if self.board.data[row_index][col_index] != 0:
                    pass
                else:
                    if self.check_player_hinges(row_index, col_index):
                        pass
                    elif self.check_adjacent_stones(row_index, col_index):
                        pass
                    else:
                        return True
